...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        ...
        do {
            ...
            // Fail open with an in-memory container in production to prevent launch crash.
            ...
            do {
                ...
                fatalError("Unable to initialize fallback in-memory SwiftData container: \(error)")
            }
        }
    }
